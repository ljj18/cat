...
public class HourlyReportContentEntity {
   ...
   public static final Readset<HourlyReportContent> READSET_FULL = new Readset<HourlyReportContent>(REPORT_ID, CONTENT, PERIOD, CREATION_DATE);

   public static final Readset<HourlyReportContent> READSET_LENGTH = new Readset<HourlyReportContent>(REPORT_ID, CONTENT_LENGTH);

   public static final Readset<HourlyReportContent> READSET_CONTENT = new Readset<HourlyReportContent>(CONTENT);

   public static final Updateset<HourlyReportContent> UPDATESET_FULL = new Updateset<HourlyReportContent>(REPORT_ID, CONTENT, PERIOD);

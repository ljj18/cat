...
import static com.dianping.cat.core.dal.DailyReportEntity.LIMITS;
...
public class DailyReport extends DataObject {
   ...
   public DailyReport setLimits(int limits) {
      setFieldUsed(LIMITS, true);
      m_limits = limits;
      return this;
   }
   ...
   public String toString() {
      ...
      sb.append(", limits: ").append(m_limits);

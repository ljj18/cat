...
public class DefaultJsonBuilder implements IVisitor {
   ...
   public void visitMetricItem(MetricItem metricItem) {
      attributes(null, ATTR_MONITORCOUNT, metricItem.getMonitorCount(), ATTR_MONITORSUM, metricItem.getMonitorSum(), ATTR_MONITORAVG, metricItem.getMonitorAvg(), ATTR_METRICITEMTEXT, metricItem.getMetricItemText(), ATTR_PRODUCTTEXT, metricItem.getProductText());
   }
   ...
   public void visitRule(Rule rule) {
      attributes(rule.getDynamicAttributes(), ATTR_ID, rule.getId());
